/* lw 说这个是渲染公式的js
 * @Date: 2020-04-03 22:56:33
 * @LastEditors: 挺哥
 * @LastEditTime: 2020-04-03 22:57:01
 * @FilePath: \ting_ge_blog\public\utils\autorender.js
 */
! function (e, t) {
                ...
                for (var o = [], i = 0; i < e.length; i++)
                    if ("text" === e[i].type) {
                        var l = e[i].data,
                            ...
                            f = 0,
                            s = void 0;
                        for (-1 !== (s = l.indexOf(t)) && (f = s, o.push({
                                type: "text",
                                data: l.slice(0, f)
                            }), d = !1);;) {
                            if (d) {
                                if (-1 === (s = l.indexOf(t, f))) break;
                                o.push({
                                    type: "text",
                                    data: l.slice(f, s)
                                }), f = s
                            } else {
                                if (-1 === (s = a(r, l, f + t.length))) break;
                                o.push({
                                    type: "math",
                                    data: l.slice(f + t.length, s),
                                    rawData: l.slice(f, s + r.length),
                                    display: n
                                }), f = s + r.length
                            }
                            d = !d
